...
const Graph = (props) => {
  ...
  useEffect(() => {
    ...
    user.weight.listWeights.forEach((e) => {
      weights = {
    ...
    //     ...data,
    //     steps: {
    //       listDates: [...data.steps.listDates, e.date.substring(0, 10)],
    //       listSteps: [...data.steps.listSteps, e.done],
    //     },
    //   });
    // });
    // console.log(data);
    ...
    //     ...data,
    //     sleeps: {
    //       listDates: [...data.sleeps.listDates, e.date.substring(0, 10)],
    //       listSleeps: [...data.sleeps.listSleeps, e.done],
    //     },
    //   });
    // });
    ...
    //   setData(...data, {
    //     kcals: {
    //       listDates: [...data.kcals.listDates, e.date.substring(0, 10)],
    //       listSleeps: [...data.kcals.listKcals, e.done],
    //     },
    //   });
    // });
  }, []);
